...
# 0 - 29 m/s for default GEGIS turbine, OBS first element in windparkcurve corresponds to 0m/s and last to 29m/s
...
const windparkcurve = [ # 300SP turbine (eta_ext= 0.93, int_loss = 0.125, sigma = 1m/s)
    0, 0, 0, 0.014904727, 0.050179057, 0.10151108, 0.17286358, 0.272061689, 0.403746343,
