...
# 0 - 29 m/s for default GEGIS turbine, OBS first element in windparkcurve corresponds to 1m/s and last to 30m/s
...
#    0, 0.00477629577745001, 0.0302318703742646, 0.0800448814605385, 0.152266619655791,
#    0.25929536973779, 0.408092534083882, 0.605619515071419, 0.809368754935627, 0.917163682052237,
...
const windparkcurve = [ # 100SP turbine (eta_ext= 0.93, int_loss = 0.125, sigma = 1m/s)
    0, 0.0175959588579867, 0.068507108051616, 0.160089762921077, 0.304533239311583, 0.518590739475579,
